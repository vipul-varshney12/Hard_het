...
// Scratch implementation  with the  repeated codes
/*const  {expect}=require("chai");

describe("Token contract",function(){
    it("Deployment shuld  assign",async function(){
        const [owner]=await ethers.getSigners();
        console.log("singhners object:",owner);
    ...
    it("should transfer",async function(){
      ...
      const  Token=await ethers.getContractFactory("Token");
       ...
       await hardhatToken.connect(addr1).transfer(addr2.address,5);
        expect(await hardhatToken.balanceOf(addr2.address)).to.equal(5);//total supply=10000;
    })
});*/